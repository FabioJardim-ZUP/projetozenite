...
df_exp['faixa_salarial_inicial'] = df_exp['Faixa Salarial'].str.split("$", n = 2).str[1]
df_exp['faixa_salarial_final'] = df_exp['Faixa Salarial'].str.split("$", n = 2).str[2]
...
try:
    df_exp['faixa_salarial_inicial'] = df_exp['faixa_salarial_inicial'].str.split(" ").str[1]
    df_exp['faixa_salarial_final'] = df_exp['faixa_salarial_final'].str.split(" ").str[1]
except:
    pass
...
df.insert(1, "Curriculo", """pcd tecnologia pne intelectual objetivo deficiencia autismo fisica visual auditiva""")
